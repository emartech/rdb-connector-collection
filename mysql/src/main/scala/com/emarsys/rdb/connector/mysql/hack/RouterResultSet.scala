...
import java.sql.{Blob, Clob, Date, NClob, Ref, ResultSet, ResultSetMetaData, RowId, SQLType, SQLWarning, SQLXML, Statement, Time, Timestamp}
import java.util.Calendar

class RouterResultSet(val delegate: ResultSet, tracker: Option[QueryExecutionTracker]) extends ResultSet{
  override def next(): Boolean = {
    val res = delegate.next()
    if(!res) {
      tracker.foreach(_.ended(System.nanoTime()))
    }
    res
  }
  ...
  override def getTime(columnIndex: Int): Time = delegate.getTime(columnIndex)

  override def getTimestamp(columnIndex: Int): Timestamp = delegate.getTimestamp(columnIndex)
  ...
  override def getBigDecimal(columnLabel: String, scale: Int): java.math.BigDecimal = delegate.getBigDecimal(columnLabel, scale)
  ...
  override def getTime(columnLabel: String): Time = delegate.getTime(columnLabel)

  override def getTimestamp(columnLabel: String): Timestamp = delegate.getTimestamp(columnLabel)
  ...
  override def updateAsciiStream(columnLabel: String, x: InputStream, length: Int): Unit = delegate.updateAsciiStream(columnLabel, x, length)

  override def updateBinaryStream(columnLabel: String, x: InputStream, length: Int): Unit = delegate.updateBinaryStream(columnLabel, x, length)

  override def updateCharacterStream(columnLabel: String, reader: Reader, length: Int): Unit = delegate.updateCharacterStream(columnLabel, reader, length)
  ...
  override def getObject(columnIndex: Int, map: util.Map[String, Class[_]]): AnyRef = delegate.getObject(columnIndex, map)
  ...
  override def getObject(columnLabel: String, map: util.Map[String, Class[_]]): AnyRef = delegate.getObject(columnLabel, map)
  ...
  override def getDate(columnLabel: String, cal: Calendar): Date = delegate.getDate(columnLabel, cal)
  ...
  override def getTimestamp(columnLabel: String, cal: Calendar): Timestamp = delegate.getTimestamp(columnLabel, cal)
  ...
  override def updateNCharacterStream(columnLabel: String, reader: Reader, length: Long): Unit = delegate.updateNCharacterStream(columnLabel, reader, length)
  ...
  override def updateAsciiStream(columnLabel: String, x: InputStream, length: Long): Unit = delegate.updateAsciiStream(columnLabel, x, length)

  override def updateBinaryStream(columnLabel: String, x: InputStream, length: Long): Unit = delegate.updateBinaryStream(columnLabel, x, length)

  override def updateCharacterStream(columnLabel: String, reader: Reader, length: Long): Unit = delegate.updateCharacterStream(columnLabel, reader, length)
  ...
  override def updateBlob(columnLabel: String, inputStream: InputStream, length: Long): Unit = delegate.updateBlob(columnLabel, inputStream, length)
  ...
  override def updateObject(columnIndex: Int, x: Any, targetSqlType: SQLType, scaleOrLength: Int): Unit = delegate.updateObject(columnIndex, x, targetSqlType, scaleOrLength)

  override def updateObject(columnLabel: String, x: Any, targetSqlType: SQLType, scaleOrLength: Int): Unit = delegate.updateObject(columnLabel, x, targetSqlType, scaleOrLength)

  override def updateObject(columnIndex: Int, x: Any, targetSqlType: SQLType): Unit = delegate.updateObject(columnIndex, x, targetSqlType)

  override def updateObject(columnLabel: String, x: Any, targetSqlType: SQLType): Unit = delegate.updateObject(columnLabel, x, targetSqlType)
