...
import com.emarsys.rdb.connector.common.models.{ConnectorCompanion, _}
...
trait PostgreSqlConnectorTrait extends ConnectorCompanion with PostgreSqlErrorHandling {
  ...
  private def createDbConfig(
    ...
    ConfigFactory
      ...
      .withValue("properties.driver", fromAnyRef("org.postgresql.Driver"))
      .withValue("properties.properties.ssl", fromAnyRef("true"))
      .withValue("properties.properties.sslmode", fromAnyRef(connectorConfig.sslMode))
      .withValue("properties.properties.loggerLevel", fromAnyRef("OFF"))
      .withValue("properties.properties.sslrootcert", fromAnyRef(rootCertPath))
  }
