...
class RouterConnection(val delegate: Connection) extends Connection {
  ...
  override def prepareStatement(sql: String): PreparedStatement = new RouterPreparedStatement(delegate.prepareStatement(sql))
  ...
  override def prepareStatement(sql: String, resultSetType: Int, resultSetConcurrency: Int): PreparedStatement = new RouterPreparedStatement(delegate.prepareStatement(sql, resultSetType, resultSetConcurrency))
  ...
  override def prepareStatement(sql: String, resultSetType: Int, resultSetConcurrency: Int, resultSetHoldability: Int): PreparedStatement = new RouterPreparedStatement(delegate.prepareStatement(sql, resultSetType, resultSetConcurrency, resultSetHoldability))
  ...
  override def prepareStatement(sql: String, autoGeneratedKeys: Int): PreparedStatement = new RouterPreparedStatement(delegate.prepareStatement(sql, autoGeneratedKeys))

  override def prepareStatement(sql: String, columnIndexes: Array[Int]): PreparedStatement = new RouterPreparedStatement(delegate.prepareStatement(sql, columnIndexes))

  override def prepareStatement(sql: String, columnNames: Array[String]): PreparedStatement = new RouterPreparedStatement(delegate.prepareStatement(sql, columnNames))
